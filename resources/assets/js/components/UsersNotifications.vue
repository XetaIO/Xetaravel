        ...
        <table class="table table-hover table-notifications">
            ...
            <tr v-bind:key="notification" v-for="notification in notifications"
                ...
                <td style="position: relative;">
                    ...
                    <i v-else-if="notification.data.type == 'badge'" :class="notification.data.icon + ' fa-4x'" :style="'color:' + notification.data.color"></i>
                    ...
                    <img v-else-if="notification.data.type == 'shop_item'" :src="notification.data.icon" alt="Shop Icon" width="60">
