        ...
        <div class="grid grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-9 col-span-12 mx-3 lg:mx-0">
                <section class="rounded-lg bg-base-100 dark:bg-base-300 shadow-md py-4 px-8 mb-10">
                    ...
                    <x-form.form method="put" action="{{ route('user.email.update') }}">
                        <div class="grid grid-cols-12 gap-4 mb-7">
                            <div class="col-span-12 lg:col-span-6">
                                <x-form.input label="E-mail" value="{{ Auth::user()->email }}" disabled/>
                            </div>
                            <div class="col-span-12 lg:col-span-6">
                                <x-form.input name="email" label="New E-mail" placeholder="Your new E-mail..." required />
                            </div>
                        </div>
                    ...
                    <x-form.form method="put" action="{{ route('user.password.update') }}">
                        <div class="grid grid-cols-12 gap-4 mb-7">
                            <div class="col-span-12 lg:col-span-4">
                                <x-form.password name="current_password" label="Current Password" placeholder="Your current Password..." required />
                            </div>
                            <div class="col-span-12 lg:col-span-4">
                ...
                @else
                    ...
                    <x-form.form method="post" action="{{ route('user.password.create') }}">
                        <div class="grid grid-cols-12 gap-4 mb-7">
                            <div class="col-span-12 lg:col-span-6">
                                <x-form.password name="password" label="New Password" placeholder="Your new Password..." required />
                            </div>
                        ...
                        <dialog id="deleteAccountModal" class="modal">
                            <div class="modal-box">
                                ...
                                <x-form.form method="delete" action="{{ route('user.delete') }}">
                                    ...
                                    <x-form.password name="password" label="Password" placeholder="Your Password..." required />
