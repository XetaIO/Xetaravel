<div>
    <section class="border border-gray-200 rounded-lg dark:bg-base-300 dark:border-gray-700 py-4 px-8 mb-10">
        ...
        <x-form method="put" action="{{ route('user.account.update') }}" enctype="multipart/form-data">
            <div class="grid grid-cols-12 gap-4 mb-7">
                <div class="col-span-12 lg:col-span-6">
                    <x-file wire:model="form.avatar" label="Avatar" accept="image/png, image/jpeg">
                        <img src="{{ Auth::user()->avatar_medium ?? '/empty-user.jpg' }}" class="h-40 rounded-lg ring-2 ring-base-content ring-offset-base-100 ring-offset-2"  alt="{{ Auth::user()->username }} avatar" />
                    </x-file>
                </div>
                <div class="col-span-12 lg:col-span-6">
