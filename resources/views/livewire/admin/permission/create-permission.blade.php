<div>
    <x-modal wire:model="showModal" title="Create a Permission" class="backdrop-blur" box-class="w-11/12 max-w-5xl">
        ...
        <x-input wire:model="form.name" name="form.name" label="Name" placeholder="Permission title..." />

        <x-textarea wire:model="form.description" name="form.description" label="Description"  placeholder="Permission description..." />
