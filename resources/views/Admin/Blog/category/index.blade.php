...
<div class="col-sm-12 col-md-10 offset-md-2 pl-2 pr-2 pb-2">
    <div class="card card-inverse bg-inverse">
        ...
        <div class="card-block">
            {{ link_to(route('admin.blog.category.create'), '<i class="fa fa-plus"></i> New Category', ['class' => 'btn btn-outline-primary mb-2'], null, false) }}
                    ...
                    <tbody>
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td>
                                    {{ link_to(
                                        route('admin.blog.category.edit', ['slug' => $category->slug, 'id' => $category->id]),
