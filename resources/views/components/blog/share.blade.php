<div class="dropdown dropdown-hover dropdown-top dropdown-center ml-3 sm:opacity-0 sm:group-hover:opacity-100">
    <button type="button" class="link link-hover flex gap-2">
    ...
    <div class="dropdown-content card card-compact shadow bg-base-100 rounded-box min-w-fit lg:min-w-[300px] @if($isSolved === true) text-slate-700 dark:text-white @endif">
