<x-layouts.app>
    ...
    <x-slot:meta>
        <x-meta title="About Me" description="Welcome to my custom personal page ! You will find a custom made Curriculum Vitae using CSS & JS with all informations you need to know about me !" />
    </x-slot:meta>
