<aside class="drawer-side">
    ...
    <div class="menu w-80 bg-base-100 min-h-full">
        ...
        @else
            <a class="group flex items-center px-4 w-full h-16 min-h-16 mt-auto shadow-md bg-slate-300 hover:text-primary dark:bg-gray-700 dark:hover:bg-gray-600 transition tooltip tooltip-top" href="{{ route('user.account.index') }}"  data-tip="My Account">
