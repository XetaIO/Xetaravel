...
<menu class="sidebar sidebar-closed" id="sidebar">
    <div class="sidebar-container">
        <ul class="nav sidebar-menu">
            <a href="{{ route('users.user.show', ['slug' => Auth::user()->slug, 'id' => Auth::user()->id]) }}" class="sidebar-avatar" title="Visit your profile !" data-toggle="tooltip" data-placement="left" data-container="body">
