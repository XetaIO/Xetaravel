...
<article class="md:max-w-none grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center bg-base-100 dark:bg-base-300 shadow-md rounded-lg p-4 mb-10">
    ...
    <div>
        ...
        <div>
            {!! Markdown::convert(Str::limit($article->content, 350)) !!}
        </div>
        ...
        <footer class="flex items-center mt-4 gap-2">
            ...
            <div class="flex flex-wrap gap-1">
                ...
                <span class="text-gray-500"> - </span>
                <span class="tooltip" data-tip="Comments">
                ...
                <span class="text-gray-500"> - </span>
                    <a class="badge badge-sm badge-primary tooltip" href="{{ $article->category->show_url }}" data-tip="Category">
