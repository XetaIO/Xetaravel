    ...
    <section class="mx-auto">
        ...
        <div class="flex flex-col items-center">
            <div class="p-8 shadow-lg rounded-lg bg-base-100 dark:bg-base-300">
                ...
                <x-form.form method="post" action="{{ route('auth.password.email') }}">
                    <x-form.input class="input-primary" name="email" label="Email" placeholder="Your E-Mail..." icon="fas-at" required autofocus inline />
