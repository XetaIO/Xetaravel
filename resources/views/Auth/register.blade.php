            ...
            @if (settings('app_register_enabled'))
                <div class="p-8 shadow-lg rounded-lg bg-base-100 dark:bg-base-300">
                    ...
                    <x-form.form method="post" action="{{ route('auth.register') }}">
                        <x-form.input name="username" label="Username" value="{{ old('username') }}" placeholder="Your Username..." icon="fas-user" required autofocus inline />
                        <x-form.input name="email" label="Email" value="{{ old('email') }}" placeholder="Your E-Mail..." icon="fas-at" required inline />
                        <x-form.password name="password" label="Password" placeholder="Your Password..." required inline />
                        <x-form.password name="password_confirmation" label="Confirm Password" placeholder="Confirm your Password..." required inline />
                        ...
                        <x-form.checkbox text="By clicking on 'Register', you accept that you have read and understand the <a class='link link-primary' href='{{ route('page.terms') }}'>Terms</a>." name="terms" />
