        ...
        <div class="mx-3">
            <div class="flex flex-col items-center">
                ...
                <x-form.form method="post" action="{{ route('auth.driver.register.validate', ['driver' => session('socialite.driver')]) }}">
                    <x-form.input class="input-primary" name="username" label="Username" value="{{ old('username') }}" placeholder="Your Username..." icon="fas-user" required autofocus inline />
                    <x-form.input class="input-primary" name="email" label="Email" value="{{ old('email') }}" placeholder="Your E-Mail..." icon="fas-at" required inline />
